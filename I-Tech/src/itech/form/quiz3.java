...
{	
	...
	private final JLabel lblPilihlahSalahSatu = new JLabel("Pilihlah salah satu jawaban yang paling tepat!");
	...
	public quiz3() 
	{
		addWindowListener(new WindowAdapter()
		{
			...
			{
				File file = new File("qq3.dat");
				
				if(file.length() != 0)
				{
					String n1 = tp.getSpecificFile("qq3.dat", 1);				
					...
					String n2 = tp.getSpecificFile("qq3.dat", 2);				
					...
					String n3 = tp.getSpecificFile("qq3.dat", 3);				
					...
					String n4 = tp.getSpecificFile("qq3.dat", 4);				
					...
					String n5 = tp.getSpecificFile("qq3.dat", 5);				
					...
					String n6 = tp.getSpecificFile("qq3.dat", 6);				
					...
					String n7 = tp.getSpecificFile("qq3.dat", 7);				
					...
					String n8 = tp.getSpecificFile("qq3.dat", 8);				
					...
					String n9 = tp.getSpecificFile("qq3.dat", 9);				
					...
					String n10 = tp.getSpecificFile("qq3.dat", 10);				
	...
	private void initializeForm()
	{
		...
		lblPilihlahSalahSatu.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblPilihlahSalahSatu.setBounds(20, 11, 363, 20);
		contentPane.add(lblPilihlahSalahSatu);
		
		JLabel lblNewLabel = new JLabel("1. C, F, E, H, G, J, I, L, ... , ... ");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel.setBounds(20, 42, 237, 14);
		contentPane.add(lblNewLabel);
		
		rdbtnNewRadioButton = new JRadioButton("M, N");
		rdbtnNewRadioButton.setBounds(20, 63, 109, 23);
		rdbtnNewRadioButton.setActionCommand("rdbtnNewRadioButton");
		contentPane.add(rdbtnNewRadioButton);
		
		rdbtnNewRadioButton_1 = new JRadioButton("K, N");
		rdbtnNewRadioButton_1.setBounds(20, 84, 109, 23);
		rdbtnNewRadioButton_1.setActionCommand("rdbtnNewRadioButton_1");
		contentPane.add(rdbtnNewRadioButton_1);
		
		rdbtnNewRadioButton_2 = new JRadioButton("L, M");
		rdbtnNewRadioButton_2.setBounds(273, 63, 109, 23);
		rdbtnNewRadioButton_2.setActionCommand("rdbtnNewRadioButton_2");
		contentPane.add(rdbtnNewRadioButton_2);
		
		rdbtnNewRadioButton_3 = new JRadioButton("P, K");
		...
		JLabel lblNewLabel_1 = new JLabel("2. 4, 5, 7, 10, 14, 19, 25, ...");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_1.setBounds(20, 125, 251, 14);
		contentPane.add(lblNewLabel_1);
		
		rdbtnNewRadioButton_4 = new JRadioButton("28");
		rdbtnNewRadioButton_4.setBounds(20, 146, 109, 23);
		rdbtnNewRadioButton_4.setActionCommand("rdbtnNewRadioButton_4");
		contentPane.add(rdbtnNewRadioButton_4);
		
		rdbtnNewRadioButton_5 = new JRadioButton("30");
		rdbtnNewRadioButton_5.setBounds(20, 167, 109, 23);
		rdbtnNewRadioButton_5.setActionCommand("rdbtnNewRadioButton_5");
		contentPane.add(rdbtnNewRadioButton_5);
		
		rdbtnNewRadioButton_6 = new JRadioButton("32");
		rdbtnNewRadioButton_6.setBounds(273, 146, 109, 23);
		rdbtnNewRadioButton_6.setActionCommand("rdbtnNewRadioButton_6");
		contentPane.add(rdbtnNewRadioButton_6);
		
		rdbtnNewRadioButton_7 = new JRadioButton("34");
		rdbtnNewRadioButton_7.setBounds(273, 167, 109, 23);
		...
		JLabel lblNewLabel_2 = new JLabel("3. Sebuah tiang bendera tingginya 3 m mempunyai bayangan di tanah sepanjang 2 m. Pada saat ");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_2.setBounds(20, 208, 627, 14);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("yang sama pohon cemara mempunyai bayangan di tanah sepanjang 10 m. Maka tinggi pohon ");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_3.setBounds(20, 229, 585, 14); //38
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("cemara tersebut adalah \u2026");
		lblNewLabel_4.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_4.setBounds(20, 250, 209, 14); //38
		contentPane.add(lblNewLabel_4);
		
		rdbtnNewRadioButton_8 = new JRadioButton("15 m");
		rdbtnNewRadioButton_8.setBounds(20, 271, 109, 23);
		rdbtnNewRadioButton_8.setActionCommand("rdbtnNewRadioButton_8");
		contentPane.add(rdbtnNewRadioButton_8);
		
		rdbtnNewRadioButton_9 = new JRadioButton("16 m");
		rdbtnNewRadioButton_9.setBounds(20, 292, 109, 23);
		rdbtnNewRadioButton_9.setActionCommand("rdbtnNewRadioButton_9");
		contentPane.add(rdbtnNewRadioButton_9);
		
		rdbtnNewRadioButton_10 = new JRadioButton("20 m");
		rdbtnNewRadioButton_10.setBounds(273, 271, 109, 23);
		rdbtnNewRadioButton_10.setActionCommand("rdbtnNewRadioButton_10");
		contentPane.add(rdbtnNewRadioButton_10);
		
		rdbtnNewRadioButton_11 = new JRadioButton("25 m");
		rdbtnNewRadioButton_11.setBounds(273, 292, 109, 23);
		...
		JLabel lblNewLabel_5 = new JLabel("4. 100, 12, 70, 24, 40, 36, ... , ...");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_5.setBounds(20, 333, 251, 14);
		contentPane.add(lblNewLabel_5);
		
		rdbtnNewRadioButton_12 = new JRadioButton("20, 48");
		rdbtnNewRadioButton_12.setBounds(20, 354, 109, 23);
		rdbtnNewRadioButton_12.setActionCommand("rdbtnNewRadioButton_12");
		contentPane.add(rdbtnNewRadioButton_12);
		
		rdbtnNewRadioButton_13 = new JRadioButton("10, 46");
		rdbtnNewRadioButton_13.setBounds(20, 375, 109, 23);
		rdbtnNewRadioButton_13.setActionCommand("rdbtnNewRadioButton_13");
		contentPane.add(rdbtnNewRadioButton_13);
		
		rdbtnNewRadioButton_14 = new JRadioButton("20, 46");
		rdbtnNewRadioButton_14.setBounds(273, 354, 109, 23);
		rdbtnNewRadioButton_14.setActionCommand("rdbtnNewRadioButton_14");
		contentPane.add(rdbtnNewRadioButton_14);
		
		rdbtnNewRadioButton_15 = new JRadioButton("10, 48");
		rdbtnNewRadioButton_15.setBounds(273, 375, 109, 23);
		...
		JLabel lblNewLabel_6 = new JLabel("5. 1, 2, 4, 6, 7, 10, 10, 14, 13, 18, ... , ...");
		lblNewLabel_6.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_6.setBounds(20, 416, 309, 14);
		contentPane.add(lblNewLabel_6);
		
		rdbtnNewRadioButton_16 = new JRadioButton("17, 20");
		rdbtnNewRadioButton_16.setBounds(20, 437, 109, 23);
		rdbtnNewRadioButton_16.setActionCommand("rdbtnNewRadioButton_16");
		contentPane.add(rdbtnNewRadioButton_16);
		
		rdbtnNewRadioButton_17 = new JRadioButton("16, 22");
		rdbtnNewRadioButton_17.setBounds(20, 458, 109, 23);
		rdbtnNewRadioButton_17.setActionCommand("rdbtnNewRadioButton_17");
		contentPane.add(rdbtnNewRadioButton_17);
		
		rdbtnNewRadioButton_18 = new JRadioButton("20, 24");
		rdbtnNewRadioButton_18.setBounds(273, 437, 109, 23);
		rdbtnNewRadioButton_18.setActionCommand("rdbtnNewRadioButton_18");
		contentPane.add(rdbtnNewRadioButton_18);
		
		rdbtnNewRadioButton_19 = new JRadioButton("19, 22");
		rdbtnNewRadioButton_19.setBounds(273, 458, 109, 23);
		...
		JLabel lblNewLabel_7 = new JLabel("6. C, C, D, C, H, H, I, H, M, M, N, M, .., .., .., ..");
		lblNewLabel_7.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_7.setBounds(742, 11, 237, 14);
		contentPane.add(lblNewLabel_7);
		
		rdbtnNewRadioButton_20 = new JRadioButton("P, Q, P, R");
		...
		rdbtnNewRadioButton_21 = new JRadioButton("P, P, Q, P");
		rdbtnNewRadioButton_21.setBounds(742, 55, 109, 23);
		rdbtnNewRadioButton_21.setActionCommand("rdbtnNewRadioButton_21");
		contentPane.add(rdbtnNewRadioButton_21);
		
		rdbtnNewRadioButton_22 = new JRadioButton("S, S, R, S");
		...
		rdbtnNewRadioButton_23 = new JRadioButton("R, R, S, R");
		rdbtnNewRadioButton_23.setBounds(1005, 55, 109, 23);
		...
		JLabel lblNewLabel_8 = new JLabel("7. Diketahui selembar seng dengan panjang 80 cm dan lebar 30 cm.");
		lblNewLabel_8.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_8.setBounds(742, 96, 483, 14);
		contentPane.add(lblNewLabel_8);
		
		JLabel lblNewLabel_9 = new JLabel("Jika panjang dan lebarnya harus dipotong dengan ukuran sama sehingga luas seng");
		lblNewLabel_9.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_9.setBounds(742, 117, 515, 14);
		contentPane.add(lblNewLabel_9);
		
		JLabel lblNewLabel_10 = new JLabel("menjadi 275 cm2, maka panjang dan lebar seng adalah ...");
		lblNewLabel_10.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_10.setBounds(742, 138, 495, 14);
		contentPane.add(lblNewLabel_10);
		
		rdbtnNewRadioButton_24 = new JRadioButton("30");
		rdbtnNewRadioButton_24.setBounds(742, 159, 109, 23);
		rdbtnNewRadioButton_24.setActionCommand("rdbtnNewRadioButton_24");
		contentPane.add(rdbtnNewRadioButton_24);
		
		rdbtnNewRadioButton_25 = new JRadioButton("25");
		rdbtnNewRadioButton_25.setBounds(742, 182, 109, 23);
		rdbtnNewRadioButton_25.setActionCommand("rdbtnNewRadioButton_25");
		contentPane.add(rdbtnNewRadioButton_25);
		
		rdbtnNewRadioButton_26 = new JRadioButton("24");
		rdbtnNewRadioButton_26.setBounds(1005, 159, 109, 23);
		rdbtnNewRadioButton_26.setActionCommand("rdbtnNewRadioButton_26");
		contentPane.add(rdbtnNewRadioButton_26);
		
		rdbtnNewRadioButton_27 = new JRadioButton("20");
		rdbtnNewRadioButton_27.setBounds(1005, 182, 109, 23);
		...
		JLabel lblNewLabel_11 = new JLabel("8. 8, 12, 10, 15, 12, 18, ... , ...");
		lblNewLabel_11.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_11.setBounds(742, 223, 196, 14);
		contentPane.add(lblNewLabel_11);
		
		rdbtnNewRadioButton_28 = new JRadioButton("13, 19");
		rdbtnNewRadioButton_28.setBounds(742, 244, 109, 23);
		rdbtnNewRadioButton_28.setActionCommand("rdbtnNewRadioButton_28");
		contentPane.add(rdbtnNewRadioButton_28);
		
		rdbtnNewRadioButton_29 = new JRadioButton("19, 20");
		rdbtnNewRadioButton_29.setBounds(741, 267, 109, 23);
		rdbtnNewRadioButton_29.setActionCommand("rdbtnNewRadioButton_29");
		contentPane.add(rdbtnNewRadioButton_29);
		
		rdbtnNewRadioButton_30 = new JRadioButton("14, 21");
		rdbtnNewRadioButton_30.setBounds(1005, 244, 109, 23);
		rdbtnNewRadioButton_30.setActionCommand("rdbtnNewRadioButton_30");
		contentPane.add(rdbtnNewRadioButton_30);
		
		rdbtnNewRadioButton_31 = new JRadioButton("15, 23");
		rdbtnNewRadioButton_31.setBounds(1005, 267, 109, 23);
		...
		JLabel lblNewLabel_12 = new JLabel("9. Di dalam kotak terdapat 3 bola biru, 4 bola merah, dan 2 bola putih. Jika diambil");
		lblNewLabel_12.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_12.setBounds(741, 308, 515, 14);
		contentPane.add(lblNewLabel_12);
		
		JLabel lblNewLabel_13 = new JLabel("7 bola tanpa pengembalian, maka peluang banyak bola merah yang terambil");
		lblNewLabel_13.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_13.setBounds(741, 329, 515, 14);
		contentPane.add(lblNewLabel_13);
		
		JLabel lblNewLabel_14 = new JLabel("dua kali banyak bola putih yang terambil adalah \u2026");
		lblNewLabel_14.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_14.setBounds(741, 350, 310, 14);
		contentPane.add(lblNewLabel_14);
		
		rdbtnNewRadioButton_32 = new JRadioButton("\u215F24");
		rdbtnNewRadioButton_32.setBounds(741, 371, 109, 23);
		rdbtnNewRadioButton_32.setActionCommand("rdbtnNewRadioButton_32");
		contentPane.add(rdbtnNewRadioButton_32);
		
		rdbtnNewRadioButton_33 = new JRadioButton("\u215F12");
		rdbtnNewRadioButton_33.setBounds(741, 394, 109, 23);
		rdbtnNewRadioButton_33.setActionCommand("rdbtnNewRadioButton_33");
		contentPane.add(rdbtnNewRadioButton_33);
		
		rdbtnNewRadioButton_34 = new JRadioButton("\u215F6");
		rdbtnNewRadioButton_34.setBounds(1005, 371, 109, 23);
		rdbtnNewRadioButton_34.setActionCommand("rdbtnNewRadioButton_34");
		contentPane.add(rdbtnNewRadioButton_34);
		
		rdbtnNewRadioButton_35 = new JRadioButton("\u215F14");
		rdbtnNewRadioButton_35.setBounds(1005, 394, 109, 23);
		...
		JLabel lblNewLabel_15 = new JLabel("10. Sebuah koperasi sekolah membeli lima lusin buku seharga Rp. 150.000,00. Jika");
		lblNewLabel_15.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_15.setBounds(741, 435, 550, 14);
		contentPane.add(lblNewLabel_15);
		
		JLabel lblNewLabel_16 = new JLabel("harga jual sebuah buku Rp. 2.800,00, maka persentase keuntungan yang diperoleh");
		lblNewLabel_16.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_16.setBounds(741, 456, 550, 14);
		contentPane.add(lblNewLabel_16);
		
		JLabel lblNewLabel_17 = new JLabel("koperasi tersebut adalah \u2026");
		lblNewLabel_17.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_17.setBounds(741, 477, 200, 14);
		contentPane.add(lblNewLabel_17);
		
		rdbtnNewRadioButton_36 = new JRadioButton("4%");
		rdbtnNewRadioButton_36.setBounds(741, 498, 109, 23);
		rdbtnNewRadioButton_36.setActionCommand("rdbtnNewRadioButton_36");
		contentPane.add(rdbtnNewRadioButton_36);
		
		rdbtnNewRadioButton_37 = new JRadioButton("6%");
		rdbtnNewRadioButton_37.setBounds(741, 521, 109, 23);
		rdbtnNewRadioButton_37.setActionCommand("rdbtnNewRadioButton_37");
		contentPane.add(rdbtnNewRadioButton_37);
		
		rdbtnNewRadioButton_38 = new JRadioButton("10%");
		rdbtnNewRadioButton_38.setBounds(1005, 498, 109, 23);
		rdbtnNewRadioButton_38.setActionCommand("rdbtnNewRadioButton_38");
		contentPane.add(rdbtnNewRadioButton_38);
		
		rdbtnNewRadioButton_39 = new JRadioButton("12%");
		rdbtnNewRadioButton_39.setBounds(1005, 521, 109, 23);
