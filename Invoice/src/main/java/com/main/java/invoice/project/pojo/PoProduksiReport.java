 ...
 */
public class PoProduksiReport
{
    private String poProduksiId;
    ...
    private String produksiHargaSatuan;
    private String produksiTotalHarga;

    private String postProduksiBarang;
    private String postProduksiTotalHarga;

    public String getPoProduksiId() {
        return poProduksiId;
    }

    public void setPoProduksiId(String poProduksiId) {
    ...
    public String getDetailProduksiId() {
        return detailProduksiId;
    }

    public void setDetailProduksiId(String detailProduksiId) {
    ...
    public String getProduksiHargaSatuan() {
        return produksiHargaSatuan;
    }

    public void setProduksiHargaSatuan(String produksiHargaSatuan) {
        this.produksiHargaSatuan = produksiHargaSatuan;
    }

    public String getProduksiTotalHarga() {
        return produksiTotalHarga;
    }

    public void setProduksiTotalHarga(String produksiTotalHarga) {
    ...
    public String getPostProduksiTotalHarga() {
        return postProduksiTotalHarga;
    }

    public void setPostProduksiTotalHarga(String postProduksiTotalHarga) {
