...
CREATE TABLE `DETAIL_EVENT` (
  ...
  `HARGA_SATUAN` decimal(13,4) NOT NULL,
...
CREATE TABLE `DETAIL_PRODUKSI` (
  ...
  `PRODUKSI_HARGA_SATUAN` decimal(13,4) NOT NULL,
  `PRODUKSI_TOTAL_HARGA` decimal(13,4) NOT NULL,
  `POST_PRODUKSI_BARANG` varchar(45) NOT NULL,
  `POST_PRODUKSI_TOTAL_HARGA` decimal(13,4) NOT NULL,
...
CREATE TABLE `KONTRAK` (
  ...
  `DATE` date NOT NULL,
  `NILAI_KONTRAK` decimal(13,4) NOT NULL,
  `DPP` decimal(13,4) NOT NULL,
  `PPN` decimal(13,4) NOT NULL,
  `PPH_23` decimal(13,4) NOT NULL,
  `SP_2D` decimal(13,4) NOT NULL,
...
CREATE TABLE `MASTER_DANA` (
  ...
  `TOTAL_CASH` decimal(13,4) NOT NULL,
...
CREATE TABLE `PO_PRODUKSI` (
  ...
  `TANGGAL` date NOT NULL,
  `NILAI_PRODUKSI` decimal(13,4) NOT NULL,
  `KETERANGAN` varchar(150) NOT NULL,
...
CREATE TABLE `TAGIHAN_MEDIA` (
  ...
  `TANGGAL` date NOT NULL,
  `NILAI_TAGIHAN` decimal(13,4) NOT NULL,
...
-- Dump completed on 2018-01-23 16:49:48
