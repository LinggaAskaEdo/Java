...
use Firstwap\Altamides\Module\MobiletraxV2\EncodedResponse;
use Firstwap\Altamides\Module\MobiletraxV2\InvalidRequestException;
use Firstwap\Altamides\Module\MobiletraxV2\Message\LocateFastMessage;
use Firstwap\Altamides\Module\MobiletraxV2\EncodedErrorResponse;
use Firstwap\Altamides\Tracking\LocationApi\Report\LocateResultField;
use Firstwap\Altamides\Module\MobiletraxV2\ResponseType;
use Firstwap\Altamides\Module\MobiletraxV2\RequestType;
use Firstwap\Altamides\Module\MobiletraxV2\MobiletraxException;
use Firstwap\Altamides\Module\MobiletraxV2\MobiletraxErrorCode;
use Firstwap\Altamides\Module\MobiletraxV2\Mcrypt;
...
{   
    ...
    protected function locate()
    {
        ...
        $rbwStatus=rbwlistFilterTarget($this->request->getSender(),$data['target'],$clientId,
     ...
     * @return \Firstwap\Altamides\Module\MobiletraxV2\Message\LocateFastMessage
     */
