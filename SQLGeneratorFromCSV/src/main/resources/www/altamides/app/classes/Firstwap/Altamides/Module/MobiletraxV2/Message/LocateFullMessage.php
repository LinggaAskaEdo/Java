 ...
 */
class LocateFullMessage extends LocateEcoMessage
{
    const CHAR_OF_COMMENT            = 255;
    const SIZE_OF_CHAR_COMMENT       = 14;
    /**
     * 
     * @return type
    ...
    public function getMessage()
    {
        ...
        try {
            ...
            if(strlen($this->data['comment']) > self::CHAR_OF_COMMENT){
                $this->data['comment'] = substr($this->data['comment'], 0 , self::CHAR_OF_COMMENT);
            }
            ...
            $this->dataEncoder->appendInt(strlen($this->data['comment']), self::SIZE_OF_CHAR_COMMENT);
            $this->dataEncoder->appendString($this->data['comment'], strlen($this->data['comment']));
