...
/**
 * Confirm personalized card and declare it ready for production.
 * 
...
@XmlRootElement(name = "ConfirmPersonalizedCardRequest")
public class ConfirmPersonalizedCardRequest {
