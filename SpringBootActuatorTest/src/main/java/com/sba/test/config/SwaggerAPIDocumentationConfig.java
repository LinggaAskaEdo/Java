...
public class SwaggerAPIDocumentationConfig
{
    ...
    {
        return new ApiInfoBuilder().title("Person REST CRUD operations API in Spring-Boot")
                .description("Sample REST API for monitoring using Spring Boot, Prometheus and Graphana ")
                .termsOfServiceUrl("")
                .version("0.0.1-SNAPSHOT")
                .contact(new Contact("Satish Sharma", "https://github.com/hellosatish/monitoring/person", "https://github.com/hellosatish")).build();
    }
